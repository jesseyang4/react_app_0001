...
//TODO: change name to /acknowledge
function Index2Page() {
  return (
        ...
        <div className="grid_12 alpha">
          <div className="box-3">
            ...
            >
              ...
              <SponsorLogoEntry sponsorNameCn="悉   尼 -  澳大利亚群英气排球俱乐部 Heroes Light Volleyball Club" imageSrc={s2_2} />
              ...
              <SponsorLogoEntry sponsorNameCn="ROBAM老板" />
              ...
              <SponsorLogoEntry sponsorNameCn="海外华人网CHINESENET" imageSrc={s9_6} />
              <SponsorLogoEntry sponsorNameCn="澳 纽网ausnz.net" imageSrc={s9_7} />
              <SponsorLogoEntry sponsorNameCn="东南网 FJSEN.COM" imageSrc={s9_8} />
              <SponsorLogoEntry sponsorNameCn="牧归人工作室MUGUIREN" imageSrc={s9_9} />
              <SponsorLogoEntry sponsorNameCn="中国城网站CHINESE TOWN.co.nz" imageSrc={s9_10} />
